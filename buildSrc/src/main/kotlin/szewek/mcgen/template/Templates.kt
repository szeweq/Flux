...
object Templates {
    ...
    fun byName(name: String): TemplateFunc {
        val method = this::class.java.getDeclaredMethod(name, JsonElement::class.java, JsonFileWriter::class.java)
        method.isAccessible = true
        return TemplateFunc { o, out -> method.invoke(Templates, o, out) }
    }
